  ...
  return (
    <div className='Navbar'>
        ...
        <div className='head'>
          ...
          <button className={defaulth === 'Hospitals Nearby'? 'selectedpgchoice' : 'onlychoice'} onClick={(e) => {navigate('/hospitalsnearby');}} value="Hospitals Nearby">Garbage Availability</button>
